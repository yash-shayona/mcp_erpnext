...
_MONETARY_METRICS = frozenset(
	{"sum_grand_total", "avg_grand_total", "min_grand_total", "max_grand_total", "sum_net_total"}
)
...
def get_quotation(quotation: str, fields: list[str]) -> dict[str, Any]:
	...
	if not doc.has_permission("read"):
		return _error("PERMISSION_DENIED", "The authenticated user cannot read that Quotation.")
